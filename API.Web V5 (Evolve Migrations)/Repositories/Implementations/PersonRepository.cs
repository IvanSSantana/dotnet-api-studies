...
public class PersonRepository : IPersonRepository
{
    ...
    public PersonRepository(IDbConnection dbConnection, AppDbContext dbContext)
    {
    ...
    {
        Person dbPerson = _dbContext.Persons.Find(id) ?? null!;
        // Person dbPerson = FindById(id).Result ?? null!;
